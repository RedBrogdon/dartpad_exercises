...
do
    ...
    # DartPad injects a method called `_result` into the combined user/test code to give it a
    # way to report results out it the DartPad UI. A method with the same name is injected
    # here so that:
    #
